...
#if DWRITE_CORE || NTDDI_VERSION >= NTDDI_WIN10_RS1
...
#if DWRITE_CORE || NTDDI_VERSION >= NTDDI_WIN10_RS2
...
#if DWRITE_CORE || NTDDI_VERSION >= NTDDI_WIN10_RS3
...
#if DWRITE_CORE || NTDDI_VERSION >= NTDDI_WIN10_RS4
...
#if DWRITE_CORE || NTDDI_VERSION >= NTDDI_WIN10_RS5
